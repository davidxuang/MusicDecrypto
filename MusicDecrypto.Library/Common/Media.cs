...
namespace MusicDecrypto.Library.Common
{
    ...
    public static class MediaTypeExtensions
    {
        ...
        public static MusicTypes SniffMusicType(this IEnumerable<byte> data)
        {
            try
            {
                return (Enum.GetValues(typeof(MusicTypes)) as IEnumerable<MusicTypes>)
                    .Single(type => type switch
                    {
                        //                                                           f     L     a     C
        ...
        public static MusicTypes SniffMusicType(this ExtendedMemoryStream data)
            => data.ToArray(16).SniffMusicType();
        ...
        public static ImageTypes SniffImageType(this IEnumerable<byte> data)
        {
            try
            {
